...
public class RestCalls {
   ...
   public static String httpPostCall(String addr, Map<String, Object> json_map, HashMap<String, String> headers) throws IOException {
    ...
    public static String httpsPostCall(String addr, Map<String, Object> json_map, HashMap<String, String> headers) throws IOException {
