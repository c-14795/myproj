...
public class SendRequests {
    ...
    public String sendReqAndUpdateOrders(String url) throws Exception {
        ...
        return task.sendReqAndUpdOrders(url);
               // RestCalls.HttpGetCall(url, new HashMap<String, Object>(), new HashMap<String, String>()).get("success").toString();

    }


    public String updateManifest(String url,String orderIdSql,String tableName) throws Exception {

        return task.updManifest(url, orderIdSql,tableName);
    }
